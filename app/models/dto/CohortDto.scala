...
object CohortDto {
  ...
  def deconstruct(dto: CohortDto): Option[(Option[Int], Option[Int], Int, String)] = dto match {
    case CohortDto(id: Option[Int], parentId: Option[Int], ownerId: Int, name: String, _: Option[List[UserDto]]) => Some(id, parentId, ownerId, name)
  }
  ...
  /**
    ...
    */
  implicit val getCohortResult: GetResult[CohortDto] = GetResult(
    r =>
      CohortDto(
        Some(r.nextInt),
        Some(r.nextInt),
  ...
  /**
    * implicit converter to coerce direct sql query into data object
    */
  implicit val getSomeCohortResult: GetResult[Some[CohortDto]] = GetResult(
    r =>
      Some(
        CohortDto(
          Some(r.nextInt),
  ...
  /**
    ...
    */
  implicit val serializer: OFormat[CohortDto] = Json.format[CohortDto]
}
